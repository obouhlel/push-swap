...
echo "\t4"
ARG="6 18 -14 1424321"; ./push_swap $ARG | wc -l
./push_swap $ARG > result/result_3
var=$(./push_swap $ARG | ./checker_linux $ARG)
if [ ${var} = "OK" ]
then
...
echo "\t5"
ARG="-444 350 807 189 555"; ./push_swap $ARG | wc -l
...
echo "\t10"
ARG="496 598 -418 -415 724 -834 -111 -710 -528 111"; ./push_swap $ARG | wc -l
...
echo "\t20"
ARG="-253 904 -590 805 838 212 -50 247 430 336 131 -306 -368 -759 -403 -23 201 -72 480 690"; ./push_swap $ARG | wc -l
