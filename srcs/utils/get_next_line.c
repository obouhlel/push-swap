...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/21 12:22:13 by obouhlel          #+#    #+#             */
/*   Updated: 2023/10/21 12:31:24 by obouhlel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static
char	*error(char *tmp, char *buffer)
{
	if (buffer)
	{
		free(buffer);
...
static
char	*get_next_line_read(int fd, char *tmp)
{
	char	*buffer;
	ssize_t	rd;
...
static
char	*get_next_line_new_tmp(char *tmp, char *line)
{
	size_t	len_tmp;
	size_t	len_line;
...
static
void	get_next_line_new_buffer(char *buffer, char *tmp)
{
	size_t	len_tmp;
	size_t	i;
